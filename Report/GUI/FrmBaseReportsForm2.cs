...
{
    public partial class FrmBaseReportsForm2 : Form
    {
        private static FrmBaseReportsForm2 basetransactionform;

        public FrmBaseReportsForm2()
        {
            InitializeComponent();
        }

        public static FrmBaseReportsForm2 GetBaseTransactionForm
        {
