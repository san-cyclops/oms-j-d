...
namespace Service
{
    public class DriverService
    {
        ...
        #region Methods
        public DataTable GetAllDriverDataTable(List<Common.ReportConditionsDataStruct> reportConditionsDataStructList, List<Common.ReportDataStruct> reportDataStructList, List<Common.ReportDataStruct> reportOrderByDataStructList)
        {
            StringBuilder querrySelect = new StringBuilder();
            var query = context.Drivers.Where("IsDelete=false");
            ...
            var queryResult = (from lc in query
                               select new
                               {
                                   FieldString1 = lc.DriverCode,
                                   FieldString2 = lc.DriverName,
        ...
        public DataTable GetAllDriverDataTable()
        {
            var query = (from lc in context.Drivers
                         select new
                         {
                             FieldString1 = lc.DriverCode,
                             FieldString2 = lc.DriverName,
        ...
        {
            IQueryable qryResult = context.Drivers
