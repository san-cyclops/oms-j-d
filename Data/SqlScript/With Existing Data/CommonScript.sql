...
VALUES ('1', 'NOLIMIT (PVT) LTD.',1,1,0,0,0,1, 0, 'Admin', GETDATE(), 'Admin', GETDATE(), 0 )

-- not effect to Old Customer
USE IBS
...
VALUES ('01', 'SUPPLIER GROUP 01', '', 0, 1, 'Admin', GETDATE(), 'Admin', GETDATE(), 0 )


USE IBS
INSERT INTO InvDepartment(DepartmentCode, DepartmentName, Remark, IsDelete, GroupOfCompanyID, CreatedUser, CreatedDate, ModifiedUser, ModifiedDate, IsDataTransfer)
VALUES ('01', 'DEFAULT', 'DEFAULT', 0, 1, 'Admin', GETDATE(), 'Admin', GETDATE(), 0 )

INSERT INTO InvCategory(InvDepartmentID, CategoryCode, CategoryName, Remark, IsDelete, GroupOfCompanyID, CreatedUser, CreatedDate, ModifiedUser, ModifiedDate, IsDataTransfer)
VALUES (1, '0001', 'DEFAULT', 'DEFAULT', 0, 1, 'Admin', GETDATE(), 'Admin', GETDATE(), 0 )

INSERT INTO InvSubCategory(InvCategoryID, SubCategoryCode, SubCategoryName, Remark, IsDelete, GroupOfCompanyID, CreatedUser, CreatedDate, ModifiedUser, ModifiedDate, IsDataTransfer)
VALUES (1, '0001', 'DEFAULT', 'DEFAULT', 0, 1, 'Admin', GETDATE(), 'Admin', GETDATE(), 0 )

INSERT INTO InvSubCategory2(InvSubCategoryID, SubCategory2Code, SubCategory2Name, Remark, IsDelete, GroupOfCompanyID, CreatedUser, CreatedDate, ModifiedUser, ModifiedDate, IsDataTransfer)
VALUES (1, '0001', 'DEFAULT', 'DEFAULT', 0, 1, 'Admin', GETDATE(), 'Admin', GETDATE(), 0 )

-- Logistic

INSERT INTO LgsDepartment(DepartmentCode, DepartmentName, Remark, IsDelete, GroupOfCompanyID, CreatedUser, CreatedDate, ModifiedUser, ModifiedDate, IsDataTransfer)
VALUES ('01', 'DEFAULT', 'DEFAULT', 0, 1, 'Admin', GETDATE(), 'Admin', GETDATE(), 0 )

INSERT INTO LgsCategory(LgsDepartmentID, CategoryCode, CategoryName, Remark, IsDelete, GroupOfCompanyID, CreatedUser, CreatedDate, ModifiedUser, ModifiedDate, IsDataTransfer)
VALUES (1, '0001', 'DEFAULT', 'DEFAULT', 0, 1, 'Admin', GETDATE(), 'Admin', GETDATE(), 0 )

INSERT INTO LgsSubCategory(LgsCategoryID, SubCategoryCode, SubCategoryName, Remark, IsDelete, GroupOfCompanyID, CreatedUser, CreatedDate, ModifiedUser, ModifiedDate, IsDataTransfer)
VALUES (1, '0001', 'DEFAULT', 'DEFAULT', 0, 1, 'Admin', GETDATE(), 'Admin', GETDATE(), 0 )

INSERT INTO LgsSubCategory2(LgsSubCategoryID, SubCategory2Code, SubCategory2Name, Remark, IsDelete, GroupOfCompanyID, CreatedUser, CreatedDate, ModifiedUser, ModifiedDate, IsDataTransfer)
VALUES (1, '0001', 'DEFAULT', 'DEFAULT', 0, 1, 'Admin', GETDATE(), 'Admin', GETDATE(), 0 )
...
USE IBS
INSERT INTO PaymentMethod ([PaymentMethodCode], [PaymentMethodName], [CommissionRate], [PaymentType], [IsDelete], [GroupOfCompanyID], [CreatedUser], [CreatedDate], [ModifiedUser], [ModifiedDate], [IsDataTransfer]) VALUES ('PM001', 'CASH', 0, 0, 0, 1, 'Admin', GetDate(), 'Admin', GetDate(), 0)
INSERT INTO PaymentMethod ([PaymentMethodCode], [PaymentMethodName], [CommissionRate], [PaymentType], [IsDelete], [GroupOfCompanyID], [CreatedUser], [CreatedDate], [ModifiedUser], [ModifiedDate], [IsDataTransfer]) VALUES ('PM002', 'CREDIT', 0, 0, 0, 1, 'Admin', GetDate(), 'Admin', GetDate(), 0)
