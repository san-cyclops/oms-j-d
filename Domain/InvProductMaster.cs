...
namespace Domain
{
    public class InvProductMaster : BaseEntity
    {
        ...
        //public virtual ICollection<InvProductStockMaster> InvProductStockMastes { get; set; }
        //public virtual ICollection<InvProductUnitConversion> InvProductUnitConversions { get; set; }
        //public virtual InvDepartment InvDepartment { get; set; }
        //public virtual InvCategory InvCategory { get; set; }
        //public virtual InvSubCategory InvSubCategory { get; set; }
        //public virtual InvSubCategory2 InvSubCategory2 { get; set; }
