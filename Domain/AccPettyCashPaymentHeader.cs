...
namespace Domain
{
    public class AccPettyCashPaymentHeader:BaseEntity
    {
        public long AccPettyCashPaymentHeaderID { get; set; }

        [DefaultValue(0)]
        public long PettyCashPaymentHeaderID { get; set; } 
        ...
        [DefaultValue(0)]
        [Description("0 - Default, 1 - Pending, 2 - Paid, 3 - Processed")]
        ...
        public virtual ICollection<AccPettyCashPaymentDetail> AccPettyCashPaymentDetails { get; set; }
    }
}
