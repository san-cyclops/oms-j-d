...
namespace Domain
{
    class AccLedgerAccountStandardMaster: BaseEntity
    {
        public long AccLedgerAccountStandardMasterID { get; set; }
        ...
        [DefaultValue(0)]
        public int CompanyType { get; set; } // Service - 1, PVT Limited - 2 , etc
